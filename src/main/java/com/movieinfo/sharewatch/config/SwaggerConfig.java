...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.OAS_30)
                .apiInfo(apiInfo()) // 2
                .select() // 3
                .apis(RequestHandlerSelectors.basePackage("com.movieinfo.sharewatch.web"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("learning the basic movie api")
                .description("movie project REST API Documentation")
                .version("1.0")
                .build();
    }
